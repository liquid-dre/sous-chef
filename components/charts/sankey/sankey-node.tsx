...
export interface SankeyNodeProps {
  ...
  /** Sous patch: value-label text under node names. Upstream hardcoded
   * "{n} sessions"; Sous flows are money. Default preserves upstream. */
...
export function SankeyNode({
  ...
  formatValueLabel = (value) => `${intFmt(value)} sessions`,
}: SankeyNodeProps) {
  const {
    nodes,
    links,

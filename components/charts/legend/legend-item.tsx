...
export function LegendItem({ className = "", children }: LegendItemProps) {
  ...
  return (
    ...
    <div
      className={cn(
        // Sous patch: named properties only (DESIGN.md §6 NEVER SHIP).
        "cursor-pointer rounded-lg px-2 py-1.5 transition-[background-color,opacity] duration-150 ease-out",

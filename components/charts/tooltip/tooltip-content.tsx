        ...
        <div className="space-y-1.5">
          {rows.map((row) => (
            ...
            >
              ...
              {/* Sous patch: `tabular-nums` is inert in Poppins — the numeric
                  utility supplies Inter + tnum (DESIGN.md §4). */}
              <span className="numeric font-medium text-chart-tooltip-foreground text-sm">
